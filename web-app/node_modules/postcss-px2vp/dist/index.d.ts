...
declare type ViewportUnit = 'vw' | 'vh' | 'vmin' | 'vmax';
declare type Option = {
    /** 需要转换的单位，默认为"px" */
...
declare type FunctionalOptions<T> = {
    [K in keyof T]: T[K] | ((rule: Rule) => T[K]);
};
declare type Input = FunctionalOptions<Option>;
interface PluginCreator<PluginOptions> {
    (options?: PluginOptions): Plugin;
    postcss: true;
}
declare const px2vp: PluginCreator<Input>;
export = px2vp;
